...
urlpatterns = [
    ...
    path(
        "users/<int:user_id>/resend-invite/", views.resend_invite_email, name="resend_invite_email"
    ),
    # WebAuthn (Passkeys)
    path(
        "webauthn/register/challenge/", views.register_challenge, name="webauthn_register_challenge"
    ),
